...
namespace AdoNetDal
{
    ...
    public partial class DataEntity : DbContext
    {
        ...
        public virtual ObjectResult<string> uspInsertFaculty(Nullable<int> pSNo, string emailId, string name)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<string>("uspInsertFaculty", pSNoParameter, emailIdParameter, nameParameter);
        }
